...
public class EditPlaylistController {
    ...
    @FXML private ComboBox<String> playlistSelector;
    @FXML private TextField playlistNameField;
    @FXML private TextField playlistDescriptionField;
    @FXML private ImageView playlistImage;
    @FXML private ListView<String> songListView;
    @FXML private Button addSongsButton, removeSongButton, changeImageButton, saveChangesButton, deletePlaylistButton;
